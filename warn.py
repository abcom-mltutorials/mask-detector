...
while True:
    ...
    for (box, pred) in zip(location, prediction):
        ...
        #To define the distance from camera. Greater the value shorter the distace required to show warning.
        if X2-X1>(125):
            #This is a % of withoutMask in front of camera. If greater than 70% then only it will show the warning.
            if withoutMask>.75:
